...
class Taxonomies_Widget extends WP_Widget {
  ...
  function __construct(){
    parent::__construct(
      ...
      sprintf(I18n::__('%s Taxonomies'), Post_Type_Labels::getEncyclopediaType()),
  ...
  function Form($options){
    ...
    <p>
      ...
      <label for="<?php echo $this->get_Field_Id('show_count') ?>"><?php printf(I18n::__('Display number of %s.'), Post_Type_Labels::getItemPluralName()) ?></label>
    </p>
    ...
    <p>
      ...
      <select id="<?php echo $this->get_Field_Id('orderby') ?>" name="<?php echo $this->get_Field_Name('orderby') ?>" class="widefat">
        ...
        <option value="count" <?php selected($options->orderby, 'count') ?>><?php printf(I18n::__('Number of %s'), Post_Type_Labels::getItemPluralName()) ?></option>
