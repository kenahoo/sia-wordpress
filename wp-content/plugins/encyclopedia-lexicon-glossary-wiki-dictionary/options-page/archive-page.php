...
<tr>
	<th><label><?php printf(I18n::__('%s per page'), Post_Type_Labels::getItemPluralName()) ?></label></th>
	<td>
    ...
    <p class="help"><?php printf(I18n::__('This option affects all %s archive pages.'), Post_Type_Labels::getEncyclopediaType()) ?></p>
  </td>
</tr>
