...
abstract class Post_Relations {

  public static function getTermRelatedItems($arguments = []){
    global $wpdb, $post;
    ...
    # Get term IDs
    $arr_term_ids = Array_Map(function($taxonomy){ return $taxonomy->term_taxonomy_id; }, $arr_terms);
